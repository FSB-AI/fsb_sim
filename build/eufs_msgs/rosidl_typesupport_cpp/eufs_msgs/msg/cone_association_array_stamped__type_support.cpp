...
static const _ConeAssociationArrayStamped_type_support_symbol_names_t _ConeAssociationArrayStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, ConeAssociationArrayStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, msg, ConeAssociationArrayStamped)),
  }
};
...
{
  return &::eufs_msgs::msg::rosidl_typesupport_cpp::ConeAssociationArrayStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, eufs_msgs, msg, ConeAssociationArrayStamped)() {
  return get_message_type_support_handle<eufs_msgs::msg::ConeAssociationArrayStamped>();
}
