...
inline void to_flow_style_yaml(
  const PurePursuitCheckpoint & msg,
  std::ostream & out)
{
  out << "{";
  // member: position
  ...
  // member: max_lateral_acceleration
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.max_lateral_acceleration, out);
  }
  out << "}";
...
inline std::string to_yaml(const PurePursuitCheckpoint & msg, bool use_flow_style = false)
{
