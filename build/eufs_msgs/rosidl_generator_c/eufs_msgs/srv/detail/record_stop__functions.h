...
#ifndef EUFS_MSGS__SRV__DETAIL__RECORD_STOP__FUNCTIONS_H_
#define EUFS_MSGS__SRV__DETAIL__RECORD_STOP__FUNCTIONS_H_
...
/// Initialize srv/RecordStop message.
/**
...
/// Finalize srv/RecordStop message.
/**
...
/// Create srv/RecordStop message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * eufs_msgs__srv__RecordStop_Request__init().
...
/// Destroy srv/RecordStop message.
/**
 * It calls
 * eufs_msgs__srv__RecordStop_Request__fini()
...
/// Check for srv/RecordStop message equality.
/**
...
/// Initialize array of srv/RecordStop messages.
/**
...
/// Finalize array of srv/RecordStop messages.
/**
 * It calls
 * eufs_msgs__srv__RecordStop_Request__fini()
...
/// Create array of srv/RecordStop messages.
/**
 * It allocates the memory for the array and calls
 * eufs_msgs__srv__RecordStop_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RecordStop messages.
/**
 * It calls
 * eufs_msgs__srv__RecordStop_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RecordStop message array equality.
/**
...
/// Copy an array of srv/RecordStop messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * eufs_msgs__srv__RecordStop_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_eufs_msgs
...
/**
 * It calls
 * eufs_msgs__srv__RecordStop_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_eufs_msgs
...
/**
 * It allocates the memory for the array and calls
 * eufs_msgs__srv__RecordStop_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_eufs_msgs
...
/**
 * It calls
 * eufs_msgs__srv__RecordStop_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EUFS_MSGS__SRV__DETAIL__RECORD_STOP__FUNCTIONS_H_
