...
{
  const auto & item = *reinterpret_cast<const eufs_msgs::msg::BoundingBox *>(
    get_const_function__BoundingBoxes__bounding_boxes(untyped_member, index));
  auto & value = *reinterpret_cast<eufs_msgs::msg::BoundingBox *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<eufs_msgs::msg::BoundingBox *>(
    get_function__BoundingBoxes__bounding_boxes(untyped_member, index));
  const auto & value = *reinterpret_cast<const eufs_msgs::msg::BoundingBox *>(untyped_value);
  item = value;
}
