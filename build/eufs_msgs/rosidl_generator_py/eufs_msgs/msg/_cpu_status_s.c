...
bool eufs_msgs__msg__cpu_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._cpu_status.CpuStatus", full_classname_dest, 35) == 0);
  }
  eufs_msgs__msg__CpuStatus * ros_message = _ros_message;
  {  // status
...
PyObject * eufs_msgs__msg__cpu_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._cpu_status");
