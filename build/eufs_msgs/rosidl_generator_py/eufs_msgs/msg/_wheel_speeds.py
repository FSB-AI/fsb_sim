...
class WheelSpeeds(metaclass=Metaclass_WheelSpeeds):
    ...
    def lf_speed(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'lf_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def rf_speed(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'rf_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def lb_speed(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'lb_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def rb_speed(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'rb_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
