...
bool eufs_msgs__msg__stereo_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._stereo_image.StereoImage", full_classname_dest, 39) == 0);
  }
  eufs_msgs__msg__StereoImage * ros_message = _ros_message;
  {  // header
  ...
  {  // color
    ...
    if (!sensor_msgs__msg__image__convert_from_py(field, &ros_message->color)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * eufs_msgs__msg__stereo_image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._stereo_image");
  ...
  {  // color
    PyObject * field = NULL;
    field = sensor_msgs__msg__image__convert_to_py(&ros_message->color);
    if (!field) {
      return NULL;
    }
    {
