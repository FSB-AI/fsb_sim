...
bool eufs_msgs__msg__particle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._particle.Particle", full_classname_dest, 32) == 0);
  }
  eufs_msgs__msg__Particle * ros_message = _ros_message;
  {  // pose
  ...
  {  // map
    ...
    if (!eufs_msgs__msg__cone_array_with_covariance__convert_from_py(field, &ros_message->map)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * eufs_msgs__msg__particle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._particle");
  ...
  {  // map
    PyObject * field = NULL;
    field = eufs_msgs__msg__cone_array_with_covariance__convert_to_py(&ros_message->map);
    if (!field) {
      return NULL;
    }
    {
