...
void fetch_function__ConeArrayWithCovariance__blue_cones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(
    get_const_function__ConeArrayWithCovariance__blue_cones(untyped_member, index));
  auto & value = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  value = item;
}

void assign_function__ConeArrayWithCovariance__blue_cones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(
    get_function__ConeArrayWithCovariance__blue_cones(untyped_member, index));
...
void fetch_function__ConeArrayWithCovariance__yellow_cones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(
    get_const_function__ConeArrayWithCovariance__yellow_cones(untyped_member, index));
  auto & value = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  value = item;
}

void assign_function__ConeArrayWithCovariance__yellow_cones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(
    get_function__ConeArrayWithCovariance__yellow_cones(untyped_member, index));
  const auto & value = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  item = value;
}
...
void fetch_function__ConeArrayWithCovariance__orange_cones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(
    get_const_function__ConeArrayWithCovariance__orange_cones(untyped_member, index));
  auto & value = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  value = item;
}

void assign_function__ConeArrayWithCovariance__orange_cones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(
    get_function__ConeArrayWithCovariance__orange_cones(untyped_member, index));
  const auto & value = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  item = value;
}
...
void fetch_function__ConeArrayWithCovariance__big_orange_cones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(
    get_const_function__ConeArrayWithCovariance__big_orange_cones(untyped_member, index));
  auto & value = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  value = item;
}

void assign_function__ConeArrayWithCovariance__big_orange_cones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(
    get_function__ConeArrayWithCovariance__big_orange_cones(untyped_member, index));
  const auto & value = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  item = value;
}
...
void fetch_function__ConeArrayWithCovariance__unknown_color_cones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(
    get_const_function__ConeArrayWithCovariance__unknown_color_cones(untyped_member, index));
  auto & value = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  value = item;
}

void assign_function__ConeArrayWithCovariance__unknown_color_cones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<eufs_msgs::msg::ConeWithCovariance *>(
    get_function__ConeArrayWithCovariance__unknown_color_cones(untyped_member, index));
  const auto & value = *reinterpret_cast<const eufs_msgs::msg::ConeWithCovariance *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConeArrayWithCovariance_message_member_array[6] = {
  ...
  },
  {
    ...
    fetch_function__ConeArrayWithCovariance__blue_cones,  // fetch(index, &value) function pointer
    assign_function__ConeArrayWithCovariance__blue_cones,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ConeArrayWithCovariance__yellow_cones,  // fetch(index, &value) function pointer
    assign_function__ConeArrayWithCovariance__yellow_cones,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ConeArrayWithCovariance__orange_cones,  // fetch(index, &value) function pointer
    assign_function__ConeArrayWithCovariance__orange_cones,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ConeArrayWithCovariance__big_orange_cones,  // fetch(index, &value) function pointer
    assign_function__ConeArrayWithCovariance__big_orange_cones,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ConeArrayWithCovariance__unknown_color_cones,  // fetch(index, &value) function pointer
    assign_function__ConeArrayWithCovariance__unknown_color_cones,  // assign(index, value) function pointer
