...
void fetch_function__Costmap__channel0(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Costmap__channel0(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Costmap__channel0(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Costmap__channel0(untyped_member, index));
...
void fetch_function__Costmap__channel1(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Costmap__channel1(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Costmap__channel1(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Costmap__channel1(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__Costmap__channel2(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Costmap__channel2(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Costmap__channel2(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Costmap__channel2(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
void fetch_function__Costmap__channel3(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__Costmap__channel3(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__Costmap__channel3(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__Costmap__channel3(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Costmap_message_member_array[9] = {
  ...
  },
  {
    ...
    fetch_function__Costmap__channel0,  // fetch(index, &value) function pointer
    assign_function__Costmap__channel0,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Costmap__channel1,  // fetch(index, &value) function pointer
    assign_function__Costmap__channel1,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Costmap__channel2,  // fetch(index, &value) function pointer
    assign_function__Costmap__channel2,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Costmap__channel3,  // fetch(index, &value) function pointer
    assign_function__Costmap__channel3,  // assign(index, value) function pointer
