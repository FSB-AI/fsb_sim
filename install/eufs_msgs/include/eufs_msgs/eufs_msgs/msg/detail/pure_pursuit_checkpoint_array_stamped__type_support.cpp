...
void fetch_function__PurePursuitCheckpointArrayStamped__checkpoints(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const eufs_msgs::msg::PurePursuitCheckpoint *>(
    get_const_function__PurePursuitCheckpointArrayStamped__checkpoints(untyped_member, index));
  auto & value = *reinterpret_cast<eufs_msgs::msg::PurePursuitCheckpoint *>(untyped_value);
  value = item;
}

void assign_function__PurePursuitCheckpointArrayStamped__checkpoints(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<eufs_msgs::msg::PurePursuitCheckpoint *>(
    get_function__PurePursuitCheckpointArrayStamped__checkpoints(untyped_member, index));
  const auto & value = *reinterpret_cast<const eufs_msgs::msg::PurePursuitCheckpoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PurePursuitCheckpointArrayStamped_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__PurePursuitCheckpointArrayStamped__checkpoints,  // fetch(index, &value) function pointer
    assign_function__PurePursuitCheckpointArrayStamped__checkpoints,  // assign(index, value) function pointer
